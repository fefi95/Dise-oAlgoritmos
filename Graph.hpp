...
class Graph {
    private:
		...
		std::vector<Edge> r2_edges; //List of requiered edges who still got benefit after crossing the, twice
        std::vector<Edge> r_edges; //List of required edges
        std::vector<Edge> n_edges; //List of non required edges

    public:
        Graph(int vertex, int r_size, int n_size,std::vector<Edge> &r2_edges, std::vector<Edge> &r_edges, std::vector<Edge> &n_edges);
...
// Constructor
Graph::Graph (int vertex, int r_size, int n_size, std::vector<Edge> &r2_edges, std::vector<Edge> &r_edges, std::vector<Edge> &n_edges) {
